...
#  identify sticky-end restriction enzyme sites in the genomic DNA
...
<!--  ====== MY CGI RESULTS ======     -->
   ...
   <h1>Results</h1>
      ...
      <p class='info'>The Restriction Enzyme Cutting Sites, with sites highlighted in red, for <b>$accession</b> entry and the restriction enzyme <b>$string</b>:</p>
      $StickyEnds
